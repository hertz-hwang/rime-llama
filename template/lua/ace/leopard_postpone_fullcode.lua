...
local function init(env)
  ...
  env.max_index = config:get_int('leopard_postpone_fullcode/lua/max_index')
      or 4
end
...
local function filter(input, env)
  ...
  if not context:get_option("leopard_postpone_fullcode") then
